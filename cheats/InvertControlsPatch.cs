...
public static class InvertControls_Patch
{
    ...
    public static void Postfix(PlayerPhysics __instance)
    {
        ...
        try
        {
            if (__instance.AmOwner && AeroMenuGUI.invertControls && __instance.body != null)
                __instance.body.velocity = -__instance.body.velocity;

            SeePlayerVent(__instance);
            AeroMenuGUI.PlayerControl_SetRoleInvisibility_SeePhantoms_Patch.ApplyVisiblePhantom(__instance.myPlayer);
        }
        catch { }
    }
}
