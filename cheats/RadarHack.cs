...
namespace AeroMenu
{
    public partial class AeroMenuGUI : MonoBehaviour
    {
        ...
        {
            new RadarMap { id = 0, res = "AeroMenu.radar_skeld.png", x = 277f, y = 77f, scale = 11.5f },
            new RadarMap { id = 1, res = "AeroMenu.radar_mira_hq.png", x = 115f, y = 240f, scale = 9.25f },
            new RadarMap { id = 2, res = "AeroMenu.radar_polus.png", x = 8f, y = 21f, scale = 10f },
            new RadarMap { id = 3, res = "AeroMenu.radar_skeld.png", x = 277f, y = 77f, scale = 11.5f },
            new RadarMap { id = 4, res = "AeroMenu.radar_airship.png", x = 162f, y = 107f, scale = 6f },
            new RadarMap { id = 5, res = "AeroMenu.radar_fungle.png", x = 237f, y = 140f, scale = 8.5f }
        };

        private static readonly RadarMap[] realisticRadarMaps =
        {
            new RadarMap { id = 0, res = "AeroMenu.radar_realistic_skeld.png", x = 277f, y = 77f, scale = 11.5f },
            new RadarMap { id = 1, res = "AeroMenu.radar_realistic_mira_hq.png", x = 115f, y = 240f, scale = 9.25f },
            new RadarMap { id = 2, res = "AeroMenu.radar_realistic_polus.png", x = 8f, y = 21f, scale = 10f },
            new RadarMap { id = 3, res = "AeroMenu.radar_realistic_skeld.png", x = 277f, y = 77f, scale = 11.5f },
            new RadarMap { id = 4, res = "AeroMenu.radar_realistic_airship.png", x = 162f, y = 107f, scale = 6f },
            new RadarMap { id = 5, res = "AeroMenu.radar_realistic_fungle.png", x = 237f, y = 140f, scale = 8.5f }
        };
