...
namespace AeroMenu
{
    public partial class AeroMenuGUI : MonoBehaviour
    {
        ...
        {
            new ReplayMap { id = 0, res = "AeroMenu.radar_skeld.png", x = 277f, y = 77f, scale = 11.5f },
            new ReplayMap { id = 1, res = "AeroMenu.radar_mira_hq.png", x = 115f, y = 240f, scale = 9.25f },
            new ReplayMap { id = 2, res = "AeroMenu.radar_polus.png", x = 8f, y = 21f, scale = 10f },
            new ReplayMap { id = 3, res = "AeroMenu.radar_skeld.png", x = 277f, y = 77f, scale = 11.5f },
            new ReplayMap { id = 4, res = "AeroMenu.radar_airship.png", x = 162f, y = 107f, scale = 6f },
            new ReplayMap { id = 5, res = "AeroMenu.radar_fungle.png", x = 237f, y = 140f, scale = 8.5f }
        };
        ...
        private static void InitReplayGui()
        {
            ...
            if (replayPlayerTex == null) replayPlayerTex = LoadReplayTex("AeroMenu.radar_player.png");
            if (replayVisorTex == null) replayVisorTex = LoadReplayTex("AeroMenu.radar_player_visor.png");
            if (replayCrossTex == null) replayCrossTex = LoadReplayTex("AeroMenu.radar_cross.png");
        }
