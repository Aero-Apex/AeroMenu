...
internal static class DarkChatTheme
{
    ...
    public static void Tick(ChatController instance)
    {
        ...
        if (!AeroMenuGUI.enableChatDarkMode)
        {
    ...
    private static void LoadIconSprites()
    {
        ...
        quickIconSprite = LoadSprite("AeroMenu.dark_chat_quick.png");
        reportIconSprite = LoadSprite("AeroMenu.dark_chat_report.png");
        keyboardIconSprite = LoadSprite("AeroMenu.dark_chat_keyboard.png");
    }
