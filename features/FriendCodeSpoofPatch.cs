...
public static class PublicFriendCodeRegistrationPatch
{
    ...
    {
        if (fallbackRequest || !AeroMenuGUI.enableFriendCodeSpoof) return true;

        string value = (AeroMenuGUI.spoofFriendCodeInput ?? string.Empty).Trim();
...
public static class PublicFriendCodeScreenPatch
{
    ...
    {
        if (!AeroMenuGUI.enableFriendCodeSpoof || __instance == null) return;
...
public static class PublicFriendCodeRandomPatch
{
    public static void Postfix(EditAccountUsername __instance)
    {
        if (!AeroMenuGUI.enableFriendCodeSpoof || __instance == null || __instance.UsernameText == null) return;
...
public static class PublicFriendCodeConfirmPatch
{
    ...
    {
        if (!AeroMenuGUI.enableFriendCodeSpoof || __instance == null) return true;
...
public static class PublicFriendCodeButtonPatch
{
    ...
    {
        if (!AeroMenuGUI.enableFriendCodeSpoof || __instance == null || enable) return;
