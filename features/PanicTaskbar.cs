...
namespace AeroMenu
{
    public partial class AeroMenuGUI : MonoBehaviour
    {
        ...
        private static void ApplyPanicMode()
        {
            ...
            try
            {
                foreach (var fld in typeof(AeroMenuGUI).GetFields(BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic))
                {
            ...
            try { Harmony.UnpatchID("com.aeromenu.harmony"); } catch { }
