...
public void OnGUI()
        {
            ...
            if (e != null && e.isKey && e.type == EventType.KeyDown)
            {
                ...
                else if (isTyping)
                {
                    ...
                    else if ((e.keyCode == KeyCode.Return || e.keyCode == KeyCode.KeypadEnter) && isEditingSearch)
                    {
            ...
            if (e != null && e.type == EventType.Repaint && screenNotifications.Count > 0)
            {
                ...
                {
                    AeroNotification notif = screenNotifications[i];
...
private void DrawMenuWindowIfVisible()
        {
            ...
            try
            {
                ...
                if (drawMenuWindow == null) drawMenuWindow = DrawAeroMenu;
...
private void TrackAnimatedSidebarHighlight(int tab, Rect rect)
        ...
        private void DrawAeroMenu(int windowID)
        {
            ...
            try
            {
                ...
                {
                    menuTitleText = ApplyMenuShimmer("Aero Menu");
