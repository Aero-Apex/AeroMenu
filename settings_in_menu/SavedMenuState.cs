...
[HarmonyPatch(typeof(PlayerPhysics), nameof(PlayerPhysics.HandleRpc))]
        public static class Shield_PetSpam_Patch
        {
            ...
            {
                if (!AeroMenuGUI.enablePasosLimit) return true;
...
private void KillAll()
        {
            ...
            if (AmongUsClient.Instance != null && AmongUsClient.Instance.AmHost)
            {
                ...
                {
                    TryHostAeroMurderPlayer(player);
                }
                return;
            }
...
private void SaveConfig()
        {
            try
            {
                ...
                SaveBool("M_ShowChatRoles", showChatRoles);
                ...
                SaveBool("M_ForceVote", forceVote);
                SaveBool("M_NoTaskMode", noTaskMode);
                SaveBool("M_AutoCompleteTasks", autoCompleteTasks);
...
private void DrawAutoHostTab()
        {
            ...
            var snapshot = AeroAutoHostService.GetStatusSnapshot();
...
private void DrawBugRoomTab()
        {
            ...
            {
                settingsDirty = true;
                AeroBugroomScoutService.ForceReload();
            }
            GUILayout.Space(6);

            var scout = AeroBugroomScoutService.GetStatusSnapshot();
