...
private void DrawPlayersHistoryTab()
        {
            ...
            GUILayout.Label(L("File: AeroPlayerHistory.txt", "Файл: AeroPlayerHistory.txt"), historyInfoStyle, GUILayout.MinWidth(220), GUILayout.ExpandWidth(false), GUILayout.Height(24));
            ...
            if (GUILayout.Button(L("Clear History", "ОЧИСТИТЬ ИСТОРИЮ"), btnStyle, GUILayout.Width(136), GUILayout.Height(24)))
                ...
                try
                {
                    ...
                    {
                        GUILayout.Label("<color=#777777>История пока пустая.</color>", centeredRichLabelStyle);
                    }
                    else
                    {
